...
import {IconLayout2, IconLogout, IconPuzzle, IconSalad, IconSettings, IconUser,} from "@tabler/icons-react";
...
export const SidebarMobile = () => {
    ...
    const getLinkClass = (path, dropdownPaths = []) => {
        if (
            ...
            return "bg-[#ffffff] text-[#000428]";
        }
        // return s.items;
        return "text-[#ffffff] relative";
    };
    ...
    return (
        <>
            <aside
                className={`z-100 fixed bottom-0 p-3 w-full overflow-auto z-40`}>
                <div
                    ...
                    <div className="flex gap-5">
                        ...
                        <nav className={`w-full md:w-full flex justify-center md:items-center gap-5 overflow-hidden md:ps-10`}>
                  ...
                  /> */}
                    ...
                    <div className={`md:w-full flex justify-center md:items-center gap-5 overflow-hidden md:ps-10 flex-none`}>
                        <ul className="flex items-center gap-2">
                            <li>
                                <Link
                                    to="/settings"
