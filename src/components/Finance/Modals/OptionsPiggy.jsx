              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-2xl bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div className="flex flex-col mt-3 sm:ml-4 sm:mt-0 ">
                  ...
                  <p className="text-sm text-gray-500 font-primary">
                    Enter the amount you want to {type.toLowerCase()} in your piggy bank ...
                  </p>
                </div>
                <div className="m-4 flex items-center gap-2 border-b border-b-gray-300 text-4xl font-semibold">
                    <span>S/.</span>
                    <input type="text" placeholder="00.00" className="text-4xl border-none outline-none focus:ring-0"/>
                </div>
