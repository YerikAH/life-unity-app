  ...
  return (
    <div className='mt-8'>
      <div className="flex items-center">
        ...
        >
          <span className="sr-only font-primary">Previous month</span>
        ...
        >
          <span className="sr-only font-primary">Next month</span>
          <IconChevronRight className="h-5 w-5" aria-hidden="true" />
        </button>
      </div>
      <div className="mt-4 grid grid-cols-7 text-center text-xs leading-6 text-gray-500 font-primary font-bold">
        <div>M</div>
        <div>T</div>
        <div>W</div>
        <div>T</div>
      ...
      <div className="mt-2 grid grid-cols-7 text-sm">
        {days.map((day, dayIdx) => (
          <div key={day.date} className={classNames(dayIdx > 6 && '', '')}>
            <button
              type="button"
              className={classNames(
                ...
                'mx-auto flex h-8 w-8 items-center justify-center rounded-full font-primary text-xs'
              )}
            >
